       ...
       function Evaluation($id){
        $('#contacternote').val($id);

         $("#evaluez-offre").unbind('click').bind('click',function(){

                    $('#evaluez-offre').prop('disabled',true);
                  $("#spin-evaluez-offre").addClass('fa fa-spinner fa-spin fa-register');


                    var form_note  = document.getElementById("Evaluationform");
                       ...
                       if(data.success==true)
                          {
                            ...
                            toastr.success(message,'Success', {
                              ...
                              $("#spin-evaluez-offre").removeClass('fa fa-spinner fa-spin fa-register');
                          $('#evaluez-offre').prop('disabled',false);
...
function findemande(id)
{
  ...
  if(id)
  {
    ...
    $("#fin_mission_demande").unbind('click').bind('click',function(e){  
                 ...
                 e.preventDefault();
                  ...
                  $("#spin_fin_mission_demande").addClass('fa fa-spinner fa-spin fa-register');
                    ...
                    var form_cloture  = document.getElementById("form_cloture_demande");
                     ...
                     console.log($("#form_cloture_demande").attr('action'));

                     console.log($("#form_cloture_demande").attr('method'));
